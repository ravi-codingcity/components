        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-start lg:gap-8">
            ...
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              ...
              <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end dark:text-white">
                <form className="w-full">
                  ...
                  <div className="border border-gray-200 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4 dark:bg-white ">
                    <input
                      type="email"
                      id="UserEmail"
