  ...
  return (
    <>
      <div className="font-poppins">
        <Header />
        <div className="flex items-start align-top justify-start bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
          <Sidebar />
          ...
          <div class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-20   ">
            ...
            <h1 class="mx-auto max-w-4xl font-display text-3xl font-bold tracking-normal text-white-300 dark:text-gray-300 sm:text-7xl py-2 sm:leading-normal	">
              Free Open Source
              <span class="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
                <svg
                  aria-hidden="true"
                  viewBox="0 0 418 42"
                  class="absolute top-2/3 left-0 h-[0.68em] w-full fill-orange-500 dark:fill-orange-300/60"
                ...
                <span class="relative ">Tailwind</span>
              </span>
              Components
            </h1>
