...
function Card_2() {
  return (
    <div className="max-w-md  py-3 m-auto">
      <div>
        <a
          href="#"
        ...
        >
          ...
          <div className="sm:flex sm:justify-between sm:gap-4">
            <div>
              ...
              <p className="mt-1 text-xs font-medium text-gray-600 dark:text-white">
                By John Doe
              </p>
            </div>
          ...
          <div className="mt-4">
            <p className="text-pretty text-sm text-gray-500 dark:text-gray-300">
          ...
          <dl className="mt-6 flex gap-4 sm:gap-6">
            ...
            <div className="flex flex-col-reverse">
              ...
              <dd className="text-xs text-gray-500 dark:text-gray-300">3 minute</dd>
            </div>
          </dl>
        </a>
      </div>
