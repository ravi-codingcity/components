        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav className="flex-1 -mx-3 space-y-3">
            ...
            {[
              ...
              { href: "/blog_card", label: "Blog Card" },
            ].map((item, index) => (
              <Link
                key={index}
                to={item.href} // Replace href with 'to' for react-router-dom Link
                className="flex font-poppins items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d={item.iconPath} // Keep using iconPath if defined, or change to specific path
                  />
                </svg>
